...
//    setTimeout(function () {
//        $.ajax({
//            url: localStorage.getItem('environment') + '/api/QuibStream/UpdateQuibPostedDate?QuibId=' + QuibId + '&Body=' + Body,
//            type: 'Put',
//            dataType: 'text',
...
//                    if ((newQuib[0].isQuibZero && IsQuibZeroOpen) || (!newQuib[0].isQuibZero && !IsQuibZeroOpen)) {
...
//            "<div class='quib-compose-header'>" +
//            "<img src='" + avatar + "' class='avatar-quibcomposer' />" +
//            "<span class='composer-name' style='font-weight: bold'> " + Quib[0].displayName + "</span>" +
...
//                    "<div class='quib-compose-wrapper'>" +
//                    "<div class='quib-compose-header'>" +
//                    "<img src='" + Quib[0].avatar + "' class='avatar-quibcomposer' />" +
//                    "<span class='composer-name' style='font-weight: bold'> " + Quib[0].displayName + "</span>" +
//                    "<span id='QuibId' class='hide'>" + Quib[0].id + "</span>" +
//                    "<div class='quib-compose-timer-wrapper'>" +
//                    "<input type='text' class='form-control quib-compose-timer' value='" + Quib[0].time + "' readonly='true' />" +
...
//        // newQuib.Id
//        var body = (newQuib.IsScreenshot == false) ? newQuib.Body : "<img style='height:auto; width:100%;' id='img" + newQuib.Id + "' src='" + newQuib.Body + "' />";

//        if (newQuib.IsScreenshot == false) {
...
//                "<div class='quib-compose-header'>" +
//                "<img src='" + avatar + "' class='avatar-quibcomposer' />" +
//                "<span class='composer-name " + SeedquibClass + "' style='font-weight: bold'> " + newQuib.DisplayName + "</span>" +
            ...
            if (response != undefined && response != null && response.length > 0) {
                ...
                if (!IsSmallerQuibPresent) {
                    ...
                    $('#myStreamPanel').prepend("<div class='mystream-wrapper'>" +
                        ...
                        "<img src='/Images/minus.png'/>" +
                         "</a>"+
                        "<input class='myStreamQuibTime mystream-time movie-timer' readonly='true' value='" + quibTimePrepend + "'/>" +
                        "<a class='btnPlus'>" +
                        " <img src='/Images/plus.png'/>" +
                        "</a>" +
                        contentTexarea +
