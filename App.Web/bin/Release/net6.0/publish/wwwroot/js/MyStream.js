...
function UpdateQuibPostedDate(QuibId, Body) {
    ...
    setTimeout(function () {
        $.ajax({
            url: localStorage.getItem('environment') + '/api/QuibStream/UpdateQuibPostedDate',
            type: 'POST',
            dataType: 'text',
...
function AddQuib() {
        ...
        if (hms == "QUIB ZERO")
            ...
            $.ajax({
                url: localStorage.getItem('environment') + '/api/QuibStream/AddQuibs',
                type: 'post',
                dataType: 'text',
                crossDomain: true,
              
                data: { body: body, time: seconds, isSeedQuib: IsSeedQuib, seedQuibType: SeedQuibType, parentId: SelectedQuibId, movieId: localStorage.getItem("MovieId"), isScreenshot: IsScreenshot, userId: localStorage.getItem("UserId") },
                success: function (response) {
            if (response != undefined && response != null) {
